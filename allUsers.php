...
<section class="forms">
    ...
    <div class="container">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="button-group">
                                ...
                                <a href="" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#deleteUser<?php echo $id; ?>">Delete</a>
                            </div>
                        </td>
                    </tr>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="exampleModalLabel">Do your confirm delete this user?</h1>
        ...
        <?php 
            ...
            $delete_the_user = mysqli_query($db, $sql);    
